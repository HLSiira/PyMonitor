...
def print_result(pkgs):
    ...
    if not pkgs:
        ...
        # text.append('<hr noshade color="#FFFFFF" width="100%" size="1" style="padding:0; margin:8px 0 8px 0; border:none; width:100%; height: 1px; color:#FFFFFF; background-color: #FFFFFF" $
        text.append('-' * 80)
...
if __name__ == '__main__':
    ...
    if len(pkgs) > 0:
        ...
        msg["Subject"] = "Package Updates on Artemis"
